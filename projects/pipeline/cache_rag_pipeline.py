...
from shared.configs.static import PERSIST_DIR, GROQ_MODEL, CACHE_RAG_TYPE
...
class CacheRAGPipeline:
    ...
    def _build_graph(self):
        def check_cache(state: Dict[str, Any]) -> Dict[str, Any]:
            ...
            hits = self.retriever.cache_search(q, top_k=1)
            if hits:
        ...
        def generate_node(state: Dict[str, Any]) -> Dict[str, Any]:
            ...
            return {"answer": content, "question": question}
        ...
        # Branch: if cache_hit True -> END; else -> retrieve -> generate -> write_cache -> END
